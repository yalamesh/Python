...
"""
    Escape sequences allow you to insert special characters in strings. Simply put a backslash (\) before the character you want to escape.
    ...
    Talking about prevention, we have two methods: either use the double backslash method, which is actually not possible for a larger string, or use the concept of raw string, i.e., adding r or R before the string.
"""
